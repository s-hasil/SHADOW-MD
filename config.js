...
//═══════[Required Variables]════════\\
global.owner = (process.env.OWNER_NUMBER || "918714504817").split(",")
...
module.exports = {
  ...
  author: (process.env.PACK_INFO || 'author;Name').split(";")[0] || 'author',
  auto_read_status: process.env.AUTO_READ_STATUS || 'false',
  packname: (process.env.PACK_INFO || 'author;Name').split(";")[1] || 'Name',
