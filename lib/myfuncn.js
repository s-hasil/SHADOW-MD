     ...
     * @returns 
      */
      ...
      /**
        ...
        * @returns
      */
      citel.quoted.download = () => downloadMediaMessage(citel.quoted, 'buffer', {}, { logger: console })
    }
  }
  if (citel.msg.url) citel.download = () => downloadMediaMessage(citel.msg, 'buffer', {}, { logger: console })
...
*/
  ...
  citel.senddoc = (doc, type, id = citel.chat, option = {
    mentions: [citel.sender], filename: Config.ownername, mimetype: type,
    externalAdRepl: {
